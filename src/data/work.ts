...
export const work = {
  ...
  killarneyPool: {
    ...
    alt: 'Indoor swimming pool and tiled pool deck at a Killarney leisure centre',
    tag: 'Leisure',
    caption: 'Killarney leisure-centre pool deck',
    badge: 'On site',
  },
  ...
  hotelEuropePool: {
    ...
    tag: 'Hotel & leisure',
    caption: 'Hotel Europe, Killarney',
    badge: 'On site',
  },
  powerscourtSpa: {
