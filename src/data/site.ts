...
export const services = [
  {
    ...
    promise: 'Restore worn marble and stone to a polished finish — without the cost of replacing the floor.',
  ...
  },
  {
    ...
    short: 'Wooden Floors',
    promise: 'Bring tired hardwood floors back to life instead of paying to replace them.',
    accent: 'blue' as const,
  ...
  },
  {
    ...
    short: 'Travertine',
    promise: 'Restore pitted, worn travertine to a smooth, even finish — no need to replace it.',
  ...
  },
  {
    ...
    short: 'Marmoleum',
    promise: 'Refresh tired marmoleum and lino to a clean, even sheen — at a fraction of replacement cost.',
    accent: 'blue' as const,
  ...
  },
  {
    ...
    promise: 'Reduce slip risk and protect staff, customers and your business from costly accidents.',
    accent: 'green' as const,
  ...
  },
  {
    ...
    short: 'Deep Cleaning',
    promise: 'Lift ingrained dirt, limescale and stubborn stains that everyday cleaning leaves behind.',
    accent: 'blue' as const,
